...
public class Demo{
    public static void main(String[] args) {
        ...
        double result5 = Calc1.square(5);
        double result6 = Calc1.squareRoot(9);
        System.out.println("Addition: " + result1 + " Subtraction: " + result2 + " Multiplication: " + result3 + " Division: " + result4 + " Square: " + result5 + " Square Root: " + result6);
    }
}
